...
<div class="content container py-5" id="content">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <h2 class="mb-4 text-center fw-bold">✏️ Edit Booking</h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-7">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <form method="POST" action="/my-bookings/{{ $booking->id }}/edit">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="people" class="form-control" min="1" max="100" value="{{ old('people', $booking->people) }}" required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Start Time</label>
                                    <input type="text" name="start_time" id="start_time" class="form-control" value="{{ old('start_time', \Carbon\Carbon::parse($booking->start_time)->format('h:i A')) }}" required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">End Time</label>
                                    <input type="text" name="end_time" id="end_time" class="form-control" value="{{ old('end_time', \Carbon\Carbon::parse($booking->end_time)->format('h:i A')) }}" required>
                                </div>

                                <!-- Hidden Date Field -->
                                <input type="hidden" name="date" id="selected_date" value="{{ old('date', $booking->date) }}" required>
...
<script>
    ...
    flatpickr("#calendar", {
        ...
        disable: bookedDates,
        allowInput: false,
        defaultDate: "{{ old('date', $booking->date) }}",
    ...
    flatpickr("#start_time", {
        ...
        time_24hr: false,
        allowInput: true,
        defaultDate: "{{ old('start_time', \Carbon\Carbon::parse($booking->start_time)->format('h:i A')) }}"
    });
    ...
    flatpickr("#end_time", {
        ...
        time_24hr: false,
        allowInput: true,
        defaultDate: "{{ old('end_time', \Carbon\Carbon::parse($booking->end_time)->format('h:i A')) }}"
    });
